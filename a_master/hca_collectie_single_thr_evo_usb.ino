  ...
  void setup_single_collective_evo_usb() {
    ...
    g_struct_coll_attr.thr_max[2] = SINGLE_COLLECTIVE_EVO_USB_THR_MAX;
    g_struct_coll_attr.thr_min[2] = SINGLE_COLLECTIVE_EVO_USB_THR_MIN;
    ...
    g_struct_coll_attr.idle_detent_axis_val[2] = SINGLE_COLLECTIVE_EVO_USB_IDLE_DETENT_AXIS_VAL;
    ...
    g_struct_coll_attr.phys_thr_latch_joy_btn[2] = SINGLE_COLLECTIVE_EVO_USB_PHYSICAL_LATCH_MOD_JOY_BUTTON_3;
