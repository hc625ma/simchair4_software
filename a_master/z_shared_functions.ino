...
void extract_modesw_val( bool *arr) {
  ...
  void parse_btn_array(bool *pb_arr, uint8_t pb_arr_size, bool *sb_arr, bool *b_state_arr, uint8_t modifier, uint8_t sbtn_offset, class Joystick_ &joy) {
    extract_special_btn_values(pb_arr,pb_arr_size,sb_arr);
  ...
  void extract_special_btn_values (bool*pba,uint8_t pba_size, bool *sba) {
